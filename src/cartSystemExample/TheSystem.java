...
public class TheSystem {
	...
	/**
	 *  this method should take a HashMap as a parameter and assign it to the original itemCollection
	...
	/**
	 * This method takes as a parameter the name of the item to be removed. It first checks if the item is in the collection, 
	 * if it is, then removes it and returns the Item object being removed. If is not in the collection then return null
	 * @param itemName
	 * @return
	 */
